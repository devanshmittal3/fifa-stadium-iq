              ...
              {!zones || zones.length === 0 ? (
                <tr>
                  <td colSpan="5" style={{ textAlign: "center", padding: "24px", color: "var(--color-text-muted)" }}>
                    ⚠️ No live telemetry streaming. Waiting for connection...
                  </td>
                </tr>
              ) : (
                zones.map((zone) => {
                  ...
                  return (
                    ...
                    >
                          ...
                          >
                            <div 
                              style={{ 
                                ...
                                height: "100%", 
                                background: !!activeRedirections[zone.id]
                                  ? "#00f0ff"
                      ...
                      <td>
                        <span className={`status-badge-inline ${activeRedirections[zone.id] ? "redirected" : zone.status}`}>
                          {activeRedirections[zone.id] ? "redirected" : zone.status}
                        </span>
                      </td>
                      <td>
                        <button
